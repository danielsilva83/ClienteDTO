...
public class ClienteDAO {
    ...
    public ClienteDAO() {
     ...
     public void adicionarClienteDTO(ClienteDTO cliente){
    ...
    public void alterarClienteDTO(ClienteDTO cliente){
        try {
    ...
    public void deletarClienteDTO(Integer id){
        try {
    ...
    public List<ClienteDTO> listarClienteDTO() throws NomeClienteMenor5CaracteresException{
        try {
